...
namespace Seminar_Room
{
    ...
    public sealed class Contract : IContract, IDisposable
    {
        ...
        public Contract(BasicTriListWithSmartObject[] devices)
        {
            ...
            InternalShutdown_Page = new Seminar_Room.Shutdown_Page(ComponentMediator, 1);

            InternalMain_Page = new Seminar_Room.Main_Page.Main_Page(ComponentMediator, 2);

            InternalLogOff_Page = new Seminar_Room.LogOff_Page(ComponentMediator, 11);

            InternalWelcome_Page = new Seminar_Room.Welcome_Page(ComponentMediator, 12);

            InternalProj_02_Source_04_Widget = new Seminar_Room.Proj_02_Source_04_Widget.Proj_02_Source_04_Widget(ComponentMediator, 13);

            InternalCam_01_Control_Widget = new Seminar_Room.Cam_01_Control_Widget(ComponentMediator, 15);

            InternalProjDisp_01_PowerScreen_Widget = new Seminar_Room.ProjDisp_01_PowerScreen_Widget(ComponentMediator, 16);

            InternalVolume_Control_02_Panel_Widget = new Seminar_Room.Volume_Control_02_Panel_Widget(ComponentMediator, 17);

            InternalCam_02_ControlPreset_Widget = new Seminar_Room.Cam_02_ControlPreset_Widget(ComponentMediator, 18);

            InternalVolume_Control_02_Cmute_Widget = new Seminar_Room.Volume_Control_02_Cmute_Widget(ComponentMediator, 19);

            InternalAdmin_Volume_Widget = new Seminar_Room.Admin_Volume_Widget.Admin_Volume_Widget(ComponentMediator, 20);

            InternalCam_02_Control_Widget = new Seminar_Room.Cam_02_Control_Widget(ComponentMediator, 22);

            InternalAdmin_Login_Widget = new Seminar_Room.Admin_Login_Widget(ComponentMediator, 23);

            InternalCam_01_ControlPreset_Widget = new Seminar_Room.Cam_01_ControlPreset_Widget(ComponentMediator, 24);
