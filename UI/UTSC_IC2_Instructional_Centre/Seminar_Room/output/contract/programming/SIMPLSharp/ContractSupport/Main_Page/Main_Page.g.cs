...
namespace Seminar_Room.Main_Page
{
    ...
    internal partial class Main_Page : IMain_Page, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            Cam_01_Control_Widget = new Seminar_Room.Main_Page.Cam_01_Control_Widget(ComponentMediator, 6);
            Volume_Control_03_Cmute_Widget = new Seminar_Room.Main_Page.Volume_Control_03_Cmute_Widget(ComponentMediator, 7);
