...
namespace Standard_Classroom.Main_Page
{
    ...
    public partial interface IProj_03_Power_Widget 
    {
        ...
        void Proj_03_Power_Widget_Visibility_fb(Proj_03_Power_WidgetBoolInputSigDelegate callback);

        /// <summary>
        /// Proj_03_Power_Widget.Visibility Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        void Proj_03_Power_Widget_Visibility_fb(bool digital);
    }
    ...
    internal partial class Proj_03_Power_Widget : IProj_03_Power_Widget, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main_Page.Proj_03_Power_Widget.Visibility_fb
                /// Proj_03_Power_Widget.Visibility
                /// </summary>
                public const uint Proj_03_Power_Widget_Visibility_fbState = 1;
        ...
        /// <inheritdoc/>
        public void Proj_03_Power_Widget_Visibility_fb(Proj_03_Power_WidgetBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.Proj_03_Power_Widget_Visibility_fbState], this);
            }
        }

        /// <inheritdoc/>
        public void Proj_03_Power_Widget_Visibility_fb(bool digital)
        {
            Proj_03_Power_Widget_Visibility_fb((sig, component) => sig.BoolValue = digital);
        }
