...
namespace Standard_Classroom.Admin_Volume_Widget
{
    ...
    public partial interface IListVolControlByItem
    {
        ...
        void ListVolControl_List_Item_Visible(ushort buttonIndex, ListVolControlBoolInputSigDelegate callback);
        ...
        void ListVolControl_List_Item_Visible(ushort buttonIndex, bool digital);
    }
    ...
    internal partial class ListVolControl
    {
        ...
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="callback">The delegate to set the feedback.</param>
        public void ListVolControl_List_Item_Visible(ushort buttonIndex, ListVolControlBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.ListVolControl_List_Item1_VisibleState + buttonIndex], this);
            }
        }
        ...
        public void ListVolControl_List_Item_Visible(ushort buttonIndex, bool digital)
        {
            ListVolControl_List_Item_Visible(buttonIndex, (sig, component) => sig.BoolValue = digital);
        }
    ...
    internal partial class ListVolControl : IListVolControl, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[0].Admin_Volume_Control_WidgetCONTRACT.BtnVolDec.Press
                /// Admin_Volume_Widget.ListVolControl.Items[0].Btn.VolDec.Press
                /// </summary>
                public const uint Items_0__BtnVolDec_PressEvent = 1201;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[0].Admin_Volume_Control_WidgetCONTRACT.BtnVolInc.Press
                /// Admin_Volume_Widget.ListVolControl.Items[0].Btn.VolInc.Press
                /// </summary>
                public const uint Items_0__BtnVolInc_PressEvent = 1202;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[1].Admin_Volume_Control_WidgetCONTRACT.BtnVolDec.Press
                /// Admin_Volume_Widget.ListVolControl.Items[1].Btn.VolDec.Press
                /// </summary>
                public const uint Items_1__BtnVolDec_PressEvent = 1203;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[1].Admin_Volume_Control_WidgetCONTRACT.BtnVolInc.Press
                /// Admin_Volume_Widget.ListVolControl.Items[1].Btn.VolInc.Press
                /// </summary>
                public const uint Items_1__BtnVolInc_PressEvent = 1204;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[2].Admin_Volume_Control_WidgetCONTRACT.BtnVolDec.Press
                /// Admin_Volume_Widget.ListVolControl.Items[2].Btn.VolDec.Press
                /// </summary>
                public const uint Items_2__BtnVolDec_PressEvent = 1205;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[2].Admin_Volume_Control_WidgetCONTRACT.BtnVolInc.Press
                /// Admin_Volume_Widget.ListVolControl.Items[2].Btn.VolInc.Press
                /// </summary>
                public const uint Items_2__BtnVolInc_PressEvent = 1206;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[3].Admin_Volume_Control_WidgetCONTRACT.BtnVolDec.Press
                /// Admin_Volume_Widget.ListVolControl.Items[3].Btn.VolDec.Press
                /// </summary>
                public const uint Items_3__BtnVolDec_PressEvent = 1207;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[3].Admin_Volume_Control_WidgetCONTRACT.BtnVolInc.Press
                /// Admin_Volume_Widget.ListVolControl.Items[3].Btn.VolInc.Press
                /// </summary>
                public const uint Items_3__BtnVolInc_PressEvent = 1208;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[4].Admin_Volume_Control_WidgetCONTRACT.BtnVolDec.Press
                /// Admin_Volume_Widget.ListVolControl.Items[4].Btn.VolDec.Press
                /// </summary>
                public const uint Items_4__BtnVolDec_PressEvent = 1209;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[4].Admin_Volume_Control_WidgetCONTRACT.BtnVolInc.Press
                /// Admin_Volume_Widget.ListVolControl.Items[4].Btn.VolInc.Press
                /// </summary>
                public const uint Items_4__BtnVolInc_PressEvent = 1210;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[5].Admin_Volume_Control_WidgetCONTRACT.BtnVolDec.Press
                /// Admin_Volume_Widget.ListVolControl.Items[5].Btn.VolDec.Press
                /// </summary>
                public const uint Items_5__BtnVolDec_PressEvent = 1211;

                /// <summary>
                /// Output or Event digital signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[5].Admin_Volume_Control_WidgetCONTRACT.BtnVolInc.Press
                /// Admin_Volume_Widget.ListVolControl.Items[5].Btn.VolInc.Press
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital signal from Control System to panel: Admin_Volume_Widget.ListVolControl.List_Item1_Visible
                /// List.VolControl.List_Item1_Visible
                /// </summary>
                public const uint ListVolControl_List_Item1_VisibleState = 1;

                /// <summary>
                /// Input or Feedback digital signal from Control System to panel: Admin_Volume_Widget.ListVolControl.List_Item2_Visible
                /// List.VolControl.List_Item2_Visible
                /// </summary>
                public const uint ListVolControl_List_Item2_VisibleState = 2;

                /// <summary>
                /// Input or Feedback digital signal from Control System to panel: Admin_Volume_Widget.ListVolControl.List_Item3_Visible
                /// List.VolControl.List_Item3_Visible
                /// </summary>
                public const uint ListVolControl_List_Item3_VisibleState = 3;

                /// <summary>
                /// Input or Feedback digital signal from Control System to panel: Admin_Volume_Widget.ListVolControl.List_Item4_Visible
                /// List.VolControl.List_Item4_Visible
                /// </summary>
                public const uint ListVolControl_List_Item4_VisibleState = 4;

                /// <summary>
                /// Input or Feedback digital signal from Control System to panel: Admin_Volume_Widget.ListVolControl.List_Item5_Visible
                /// List.VolControl.List_Item5_Visible
                /// </summary>
                public const uint ListVolControl_List_Item5_VisibleState = 5;

                /// <summary>
                /// Input or Feedback digital signal from Control System to panel: Admin_Volume_Widget.ListVolControl.List_Item6_Visible
            ...
            {
                /// <summary>
                /// Output or Event analog signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[0].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouch
                /// Admin_Volume_Widget.ListVolControl.Items[0].Guage.Vol.Lower Touch
                /// </summary>
                public const uint Items_0__GuageVol_LowerTouchEvent = 1801;

                /// <summary>
                /// Output or Event analog signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[1].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouch
                /// Admin_Volume_Widget.ListVolControl.Items[1].Guage.Vol.Lower Touch
                /// </summary>
                public const uint Items_1__GuageVol_LowerTouchEvent = 1802;

                /// <summary>
                /// Output or Event analog signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[2].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouch
                /// Admin_Volume_Widget.ListVolControl.Items[2].Guage.Vol.Lower Touch
                /// </summary>
                public const uint Items_2__GuageVol_LowerTouchEvent = 1803;

                /// <summary>
                /// Output or Event analog signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[3].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouch
                /// Admin_Volume_Widget.ListVolControl.Items[3].Guage.Vol.Lower Touch
                /// </summary>
                public const uint Items_3__GuageVol_LowerTouchEvent = 1804;

                /// <summary>
                /// Output or Event analog signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[4].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouch
                /// Admin_Volume_Widget.ListVolControl.Items[4].Guage.Vol.Lower Touch
                /// </summary>
                public const uint Items_4__GuageVol_LowerTouchEvent = 1805;

                /// <summary>
                /// Output or Event analog signal from panel to Control System: Admin_Volume_Widget.ListVolControl.Items[5].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouch
                /// Admin_Volume_Widget.ListVolControl.Items[5].Guage.Vol.Lower Touch
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback analog signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[0].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouchfb
                ...
                /// <summary>
                /// Input or Feedback analog signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[1].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouchfb
                ...
                /// <summary>
                /// Input or Feedback analog signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[2].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouchfb
                ...
                /// <summary>
                /// Input or Feedback analog signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[3].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouchfb
                ...
                /// <summary>
                /// Input or Feedback analog signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[4].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouchfb
                ...
                /// <summary>
                /// Input or Feedback analog signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[5].Admin_Volume_Control_WidgetCONTRACT.GuageVol.LowerTouchfb
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[0].Admin_Volume_Control_WidgetCONTRACT.StrVolName.Indirect
                /// Admin_Volume_Widget.ListVolControl.Items[0].Str.VolName.Indirect
                /// </summary>
                public const uint Items_0__StrVolName_IndirectState = 1;
                /// <summary>
                /// Input or Feedback serial signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[1].Admin_Volume_Control_WidgetCONTRACT.StrVolName.Indirect
                /// Admin_Volume_Widget.ListVolControl.Items[1].Str.VolName.Indirect
                /// </summary>
                public const uint Items_1__StrVolName_IndirectState = 2;
                /// <summary>
                /// Input or Feedback serial signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[2].Admin_Volume_Control_WidgetCONTRACT.StrVolName.Indirect
                /// Admin_Volume_Widget.ListVolControl.Items[2].Str.VolName.Indirect
                /// </summary>
                public const uint Items_2__StrVolName_IndirectState = 3;
                /// <summary>
                /// Input or Feedback serial signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[3].Admin_Volume_Control_WidgetCONTRACT.StrVolName.Indirect
                /// Admin_Volume_Widget.ListVolControl.Items[3].Str.VolName.Indirect
                /// </summary>
                public const uint Items_3__StrVolName_IndirectState = 4;
                /// <summary>
                /// Input or Feedback serial signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[4].Admin_Volume_Control_WidgetCONTRACT.StrVolName.Indirect
                /// Admin_Volume_Widget.ListVolControl.Items[4].Str.VolName.Indirect
                /// </summary>
                public const uint Items_4__StrVolName_IndirectState = 5;
                /// <summary>
                /// Input or Feedback serial signal from Control System to panel: Admin_Volume_Widget.ListVolControl.Items[5].Admin_Volume_Control_WidgetCONTRACT.StrVolName.Indirect
        ...
        /// <summary>
        /// Boolean feedback List.VolControl.List_Item1_Visible (from Control System to Panel)
        /// </summary>
        ...
        /// <summary>
        /// Boolean feedback List.VolControl.List_Item2_Visible (from Control System to Panel)
        /// </summary>
        ...
        /// <summary>
        /// Boolean feedback List.VolControl.List_Item3_Visible (from Control System to Panel)
        /// </summary>
        ...
        /// <summary>
        /// Boolean feedback List.VolControl.List_Item4_Visible (from Control System to Panel)
        /// </summary>
        ...
        /// <summary>
        /// Boolean feedback List.VolControl.List_Item5_Visible (from Control System to Panel)
        /// </summary>
        ...
        /// <summary>
        /// Boolean feedback List.VolControl.List_Item6_Visible (from Control System to Panel)
        /// </summary>
        ...
        /// <summary>
        /// Numeric feedback Admin_Volume_Widget.ListVolControl.Items[0].Guage.Vol.Lower Touch fb
        /// </summary>
        /// <param name="itemIndex">Index of the Widget List (0 based).</param>
        /// <param name="callback">The ushort delegate to update the panel.</param>
        ...
        /// <summary>
        /// Numeric feedback Admin_Volume_Widget.ListVolControl.Items[1].Guage.Vol.Lower Touch fb
        /// </summary>
        /// <param name="itemIndex">Index of the Widget List (0 based).</param>
        /// <param name="callback">The ushort delegate to update the panel.</param>
        ...
        /// <summary>
        /// Numeric feedback Admin_Volume_Widget.ListVolControl.Items[2].Guage.Vol.Lower Touch fb
        /// </summary>
        /// <param name="itemIndex">Index of the Widget List (0 based).</param>
        /// <param name="callback">The ushort delegate to update the panel.</param>
        ...
        /// <summary>
        /// Numeric feedback Admin_Volume_Widget.ListVolControl.Items[3].Guage.Vol.Lower Touch fb
        /// </summary>
        /// <param name="itemIndex">Index of the Widget List (0 based).</param>
        /// <param name="callback">The ushort delegate to update the panel.</param>
        ...
        /// <summary>
        /// Numeric feedback Admin_Volume_Widget.ListVolControl.Items[4].Guage.Vol.Lower Touch fb
        /// </summary>
        /// <param name="itemIndex">Index of the Widget List (0 based).</param>
        /// <param name="callback">The ushort delegate to update the panel.</param>
        ...
        /// <summary>
        /// Numeric feedback Admin_Volume_Widget.ListVolControl.Items[5].Guage.Vol.Lower Touch fb
        /// </summary>
        /// <param name="itemIndex">Index of the Widget List (0 based).</param>
        /// <param name="callback">The ushort delegate to update the panel.</param>
        ...
        /// <summary>
        /// String feedback Admin_Volume_Widget.ListVolControl.Items[0].Str.VolName.Indirect
        /// </summary>
        ...
        /// <summary>
        /// String feedback Admin_Volume_Widget.ListVolControl.Items[1].Str.VolName.Indirect
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="callback">The delegate to set the string feedback.</param>
        ...
        /// <summary>
        /// String feedback Admin_Volume_Widget.ListVolControl.Items[2].Str.VolName.Indirect
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="callback">The delegate to set the string feedback.</param>
        ...
        /// <summary>
        /// String feedback Admin_Volume_Widget.ListVolControl.Items[3].Str.VolName.Indirect
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="callback">The delegate to set the string feedback.</param>
        ...
        /// <summary>
        /// String feedback Admin_Volume_Widget.ListVolControl.Items[4].Str.VolName.Indirect
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="callback">The delegate to set the string feedback.</param>
        ...
        /// <summary>
        /// String feedback Admin_Volume_Widget.ListVolControl.Items[5].Str.VolName.Indirect
        /// </summary>
        /// <param name="buttonIndex">The index of the button (0 based).</param>
        /// <param name="callback">The delegate to set the string feedback.</param>
