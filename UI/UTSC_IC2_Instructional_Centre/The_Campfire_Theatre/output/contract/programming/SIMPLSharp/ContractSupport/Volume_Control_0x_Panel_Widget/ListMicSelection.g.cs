...
namespace The_Campfire_Theatre.Volume_Control_0x_Panel_Widget
{
    ...
    public partial interface IListMicSelection : IListMicSelectionByItem
    {
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_5_Button_Selected(ListMicSelectionBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_6_Button_Selected(ListMicSelectionBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_7_Button_Selected(ListMicSelectionBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_8_Button_Selected(ListMicSelectionBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_9_Button_Selected(ListMicSelectionBoolInputSigDelegate callback);
    ...
    internal partial class ListMicSelection : IListMicSelection, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_0x_Panel_Widget.ListMicSelection.Button5ItemPress
                /// Button5.ItemPress
                /// </summary>
                public const uint Button_5_Button_PressEvent = 1005;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_0x_Panel_Widget.ListMicSelection.Button6ItemPress
                /// Button6.ItemPress
                /// </summary>
                public const uint Button_6_Button_PressEvent = 1006;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_0x_Panel_Widget.ListMicSelection.Button7ItemPress
                /// Button7.ItemPress
                /// </summary>
                public const uint Button_7_Button_PressEvent = 1007;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_0x_Panel_Widget.ListMicSelection.Button8ItemPress
                /// Button8.ItemPress
                /// </summary>
                public const uint Button_8_Button_PressEvent = 1008;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_0x_Panel_Widget.ListMicSelection.Button9ItemPress
                /// Button9.ItemPress
                /// </summary>
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Volume_Control_0x_Panel_Widget.ListMicSelection.Button5ItemSelected
                /// Button5.ItemSelected
                /// </summary>
                public const uint Button_5_Button_SelectedState = 1005;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Volume_Control_0x_Panel_Widget.ListMicSelection.Button6ItemSelected
                /// Button6.ItemSelected
                /// </summary>
                public const uint Button_6_Button_SelectedState = 1006;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Volume_Control_0x_Panel_Widget.ListMicSelection.Button7ItemSelected
                /// Button7.ItemSelected
                /// </summary>
                public const uint Button_7_Button_SelectedState = 1007;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Volume_Control_0x_Panel_Widget.ListMicSelection.Button8ItemSelected
                /// Button8.ItemSelected
                /// </summary>
                public const uint Button_8_Button_SelectedState = 1008;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Volume_Control_0x_Panel_Widget.ListMicSelection.Button9ItemSelected
        ...
        /// <inheritdoc/>
        public void Button_5_Button_Selected(ListMicSelectionBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_6_Button_Selected(ListMicSelectionBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_7_Button_Selected(ListMicSelectionBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_8_Button_Selected(ListMicSelectionBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_9_Button_Selected(ListMicSelectionBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
