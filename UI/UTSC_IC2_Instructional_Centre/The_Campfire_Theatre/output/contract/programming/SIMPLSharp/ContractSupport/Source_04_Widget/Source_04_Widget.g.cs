...
namespace The_Campfire_Theatre.Source_04_Widget
{
    ...
    public partial interface ISource_04_Widget 
    {
        ...
        void BtnSendToProj_1__IndirectRichText(Source_04_WidgetStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void btnSendToProj_2__IndirectRichText(Source_04_WidgetStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void StrProj_1__CurrentSrc_Indirect(Source_04_WidgetStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void StrProj_2__CurrentSrc_Indirect(Source_04_WidgetStringInputSigDelegate callback);
        ...
        /// </summary>
        The_Campfire_Theatre.Source_04_Widget.IBtnListSrcSelect BtnListSrcSelect { get; }
    }
    ...
    /// <param name="source_04_widget">The <see cref="ISource_04_Widget"/> on which to apply the feedback.</param>
    public delegate void Source_04_WidgetStringInputSigDelegate(StringInputSig stringInputSig, ISource_04_Widget source_04_widget);
    ...
    internal partial class Source_04_Widget : ISource_04_Widget, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Source_04_Widget.BtnSendToAll.Press
                /// Btn.SendToAll.Press
                /// </summary>
                public const uint BtnSendToAll_PressEvent = 3;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Source_04_Widget.BtnSendToProj[1].Press
                /// Btn.SendToProj[1].Press
                /// </summary>
                public const uint BtnSendToProj_1__PressEvent = 4;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Source_04_Widget.btnSendToProj[2].Press
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Source_04_Widget.BtnSendToProj[1].IndirectRichText
                /// Btn.SendToProj[1].Indirect Rich Text
                /// </summary>
                public const uint BtnSendToProj_1__IndirectRichTextState = 1;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Source_04_Widget.btnSendToProj[2].IndirectRichText
                /// btn.SendToProj[2].Indirect Rich Text
                /// </summary>
                public const uint btnSendToProj_2__IndirectRichTextState = 2;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Source_04_Widget.StrProj[1]_CurrentSrc.Indirect
                /// Str.Proj[1]_CurrentSrc.Indirect
                /// </summary>
                public const uint StrProj_1__CurrentSrc_IndirectState = 3;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Source_04_Widget.StrProj[2]_CurrentSrc.Indirect
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            BtnListSrcSelect = new The_Campfire_Theatre.Source_04_Widget.BtnListSrcSelect(ComponentMediator, 12);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((The_Campfire_Theatre.Source_04_Widget.BtnListSrcSelect)BtnListSrcSelect).AddDevice(device);
        }
        ...
        public void RemoveDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((The_Campfire_Theatre.Source_04_Widget.BtnListSrcSelect)BtnListSrcSelect).RemoveDevice(device);
        }
        ...
        /// <inheritdoc/>
        public void BtnSendToProj_1__IndirectRichText(Source_04_WidgetStringInputSigDelegate callback)
        {
        ...
        /// <inheritdoc/>
        public void btnSendToProj_2__IndirectRichText(Source_04_WidgetStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void StrProj_1__CurrentSrc_Indirect(Source_04_WidgetStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void StrProj_2__CurrentSrc_Indirect(Source_04_WidgetStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// ComplexComponent BtnList.SrcSelect
        /// </summary>
        public The_Campfire_Theatre.Source_04_Widget.IBtnListSrcSelect BtnListSrcSelect { get; private set; }
