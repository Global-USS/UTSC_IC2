...
namespace The_Campfire_Theatre
{
    ...
    public partial interface ICam_03_Control_Widget 
    {
        ...
        void Button_1_Visibility(Cam_03_Control_WidgetBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_Visibility(Cam_03_Control_WidgetBoolInputSigDelegate callback);
    ...
    internal partial class Cam_03_Control_Widget : ICam_03_Control_Widget, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Cam_03_Control_Widget.Button_1.Visibility
                /// Button_1.Visibility
                /// </summary>
                public const uint Button_1_VisibilityState = 1;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Cam_03_Control_Widget.Button.Visibility
                /// Button.Visibility
                /// </summary>
        ...
        /// <inheritdoc/>
        public void Button_1_Visibility(Cam_03_Control_WidgetBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_Visibility(Cam_03_Control_WidgetBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
