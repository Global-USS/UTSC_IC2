...
namespace The_Campfire_Theatre
{
    ...
    public partial interface ICam_03_ControlPreset_Widget 
    {
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void IndicatorCam_1_Selected_Visibility(Cam_03_ControlPreset_WidgetBoolInputSigDelegate callback);
        ...
        void VideoCam_1__SnapshotURL(Cam_03_ControlPreset_WidgetStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void VideoCam_2__SnapshotURL(Cam_03_ControlPreset_WidgetStringInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The <see cref="string"/> delegate to update the panel.</param>
        void VideoCam_3__SnapshotURL(Cam_03_ControlPreset_WidgetStringInputSigDelegate callback);
    ...
    internal partial class Cam_03_ControlPreset_Widget : ICam_03_ControlPreset_Widget, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Strings
            {
                ...
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Cam_03_ControlPreset_Widget.VideoCam[1].SnapshotURL
                /// Video.Cam[1].Snapshot URL
                /// </summary>
                public const uint VideoCam_1__SnapshotURLState = 11;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Cam_03_ControlPreset_Widget.VideoCam[2].SnapshotURL
                /// Video.Cam[2].Snapshot URL
                /// </summary>
                public const uint VideoCam_2__SnapshotURLState = 12;
                /// <summary>
                /// Input or Feedback serial joinInfo from Control System to panel: Cam_03_ControlPreset_Widget.VideoCam[3].SnapshotURL
        ...
        /// <inheritdoc/>
        public void VideoCam_1__SnapshotURL(Cam_03_ControlPreset_WidgetStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void VideoCam_2__SnapshotURL(Cam_03_ControlPreset_WidgetStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void VideoCam_3__SnapshotURL(Cam_03_ControlPreset_WidgetStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
