...
namespace Active_Learning_Classroom.Main_Page
{
    ...
    public partial interface IVolume_Control_03_Panel_Widget 
    {
        ...
        void Volume_Control_03_Panel_Widget_Visibility_fb(Volume_Control_03_Panel_WidgetBoolInputSigDelegate callback);

        /// <summary>
        /// Volume_Control_03_Panel_Widget.Visibility Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        void Volume_Control_03_Panel_Widget_Visibility_fb(bool digital);
    }
    ...
    internal partial class Volume_Control_03_Panel_Widget : IVolume_Control_03_Panel_Widget, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main_Page.Volume_Control_03_Panel_Widget.Visibility_fb
                /// Volume_Control_03_Panel_Widget.Visibility
                /// </summary>
                public const uint Volume_Control_03_Panel_Widget_Visibility_fbState = 1;
        ...
        /// <inheritdoc/>
        public void Volume_Control_03_Panel_Widget_Visibility_fb(Volume_Control_03_Panel_WidgetBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.Volume_Control_03_Panel_Widget_Visibility_fbState], this);
            }
        }

        /// <inheritdoc/>
        public void Volume_Control_03_Panel_Widget_Visibility_fb(bool digital)
        {
            Volume_Control_03_Panel_Widget_Visibility_fb((sig, component) => sig.BoolValue = digital);
        }
