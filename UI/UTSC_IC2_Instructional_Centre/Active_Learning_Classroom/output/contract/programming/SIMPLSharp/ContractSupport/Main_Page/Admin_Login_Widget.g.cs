...
namespace Active_Learning_Classroom.Main_Page
{
    ...
    public partial interface IAdmin_Login_Widget 
    {
        ...
        void Admin_Login_Widget_Visibility(Admin_Login_WidgetBoolInputSigDelegate callback);

        /// <summary>
        /// Admin_Login_Widget.Visibility Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        void Admin_Login_Widget_Visibility(bool digital);
    }
    ...
    internal partial class Admin_Login_Widget : IAdmin_Login_Widget, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Input or Feedback digital signal from Control System to panel: Main_Page.Admin_Login_Widget.Visibility
                /// Admin_Login_Widget.Visibility
                /// </summary>
                public const uint Admin_Login_Widget_VisibilityState = 1;
        ...
        /// <summary>
        /// Boolean feedback Admin_Login_Widget.Visibility (from Control System to Panel)
        /// </summary>
        public void Admin_Login_Widget_Visibility(Admin_Login_WidgetBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.Admin_Login_Widget_VisibilityState], this);
            }
        }
        ...
        /// Boolean feedback Admin_Login_Widget.Visibility (from Control System to Panel)
        /// </summary>
        public void Admin_Login_Widget_Visibility(bool digital)
        {
            Admin_Login_Widget_Visibility((sig, component) => sig.BoolValue = digital);
        }
