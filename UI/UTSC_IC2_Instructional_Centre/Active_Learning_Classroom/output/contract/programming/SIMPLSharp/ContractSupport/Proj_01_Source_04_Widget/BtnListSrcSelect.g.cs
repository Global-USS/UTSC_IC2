...
namespace Active_Learning_Classroom.Proj_01_Source_04_Widget
{
    ...
    public partial interface IBtnListSrcSelect : IBtnListSrcSelectByItem
    {
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_5_Button_Selected(BtnListSrcSelectBoolInputSigDelegate callback);
        ...
        /// <summary>
        /// Button5.Visible Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void Button_5_Button_Visible(BtnListSrcSelectBoolInputSigDelegate callback);
    ...
    internal partial class BtnListSrcSelect : IBtnListSrcSelect, IDisposable
    {
        ...
        /// <inheritdoc/>
        public void Button_5_Button_Selected(BtnListSrcSelectBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void Button_5_Button_Visible(BtnListSrcSelectBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
