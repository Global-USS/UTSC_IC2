...
namespace Standard_Lab.Main_Page
{
    ...
    public partial interface IMain_Page 
    {
        ...
        /// <summary>
        /// Btn.PrivacyMuteTgl.Visibility Feedback
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void BtnPrivacyMuteTgl_Visibility_fb(Main_PageBoolInputSigDelegate callback);

        /// <summary>
        /// Btn.PrivacyMuteTgl.Visibility Feedback
        /// </summary>
        /// <param name="digital">The bool to update the panel.</param>
        void BtnPrivacyMuteTgl_Visibility_fb(bool digital);
    ...
    internal partial class Main_Page : IMain_Page, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main_Page.BtnPrivacyMuteTgl.Visibility_fb
                /// Btn.PrivacyMuteTgl.Visibility
                /// </summary>
                public const uint BtnPrivacyMuteTgl_Visibility_fbState = 2;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main_Page.DateTime.Visibility_fb
                /// Date Time.Visibility
                /// </summary>
                public const uint DateTime_Visibility_fbState = 3;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Main_Page.Logo.Visibility_fb
                /// Logo.Visibility
                /// </summary>
                public const uint Logo_Visibility_fbState = 4;
                ...
                /// </summary>
                public const uint TxtLogOffMsg_Visibility_fbState = 6;
        ...
        /// <inheritdoc/>
        public void BtnPrivacyMuteTgl_Visibility_fb(Main_PageBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].BooleanInput[Joins.Booleans.BtnPrivacyMuteTgl_Visibility_fbState], this);
            }
        }

        /// <inheritdoc/>
        public void BtnPrivacyMuteTgl_Visibility_fb(bool digital)
        {
            BtnPrivacyMuteTgl_Visibility_fb((sig, component) => sig.BoolValue = digital);
        }
        /// <inheritdoc/>
