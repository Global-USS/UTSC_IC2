...
namespace Standard_Lab.Main_Page
{
    ...
    public partial interface IMain_Page 
    {
        ...
        /// </summary>
        Standard_Lab.Main_Page.IProj_01_PowerScreen_Widget Proj_01_PowerScreen_Widget { get; }

        /// <summary>
        /// ComplexComponent Proj_02_Power-Screen_Widget
        /// </summary>
        Standard_Lab.Main_Page.IProj_02_PowerScreen_Widget Proj_02_PowerScreen_Widget { get; }

        /// <summary>
        /// ComplexComponent Admin_Login_Widget
        /// </summary>
        Standard_Lab.Main_Page.IAdmin_Login_Widget Admin_Login_Widget { get; }

        /// <summary>
        /// ComplexComponent Proj_02_Source_Widget
        /// </summary>
        Standard_Lab.Main_Page.IProj_02_Source_Widget Proj_02_Source_Widget { get; }

        /// <summary>
        /// ComplexComponent Proj_01_Source_Widget
        /// </summary>
        Standard_Lab.Main_Page.IProj_01_Source_Widget Proj_01_Source_Widget { get; }

        /// <summary>
        /// ComplexComponent Volume_Control_0x_Panel_Widget
        /// </summary>
        Standard_Lab.Main_Page.IVolume_Control_0x_Panel_Widget Volume_Control_0x_Panel_Widget { get; }

        /// <summary>
        /// ComplexComponent Volume_Control_03_Panel_Widget
        /// </summary>
        Standard_Lab.Main_Page.IVolume_Control_03_Panel_Widget Volume_Control_03_Panel_Widget { get; }

        /// <summary>
        /// ComplexComponent Admin_Volume_Widget
        /// </summary>
        Standard_Lab.Main_Page.IAdmin_Volume_Widget Admin_Volume_Widget { get; }
    }
    ...
    internal partial class Main_Page : IMain_Page, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// </summary>
                public const uint BtnMasterMuteTgl_SelectedState = 9;
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            Proj_01_PowerScreen_Widget = new Standard_Lab.Main_Page.Proj_01_PowerScreen_Widget(ComponentMediator, 5);
            Proj_02_PowerScreen_Widget = new Standard_Lab.Main_Page.Proj_02_PowerScreen_Widget(ComponentMediator, 6);
            Admin_Login_Widget = new Standard_Lab.Main_Page.Admin_Login_Widget(ComponentMediator, 7);
            Proj_02_Source_Widget = new Standard_Lab.Main_Page.Proj_02_Source_Widget(ComponentMediator, 8);
            Proj_01_Source_Widget = new Standard_Lab.Main_Page.Proj_01_Source_Widget(ComponentMediator, 9);
            Volume_Control_0x_Panel_Widget = new Standard_Lab.Main_Page.Volume_Control_0x_Panel_Widget(ComponentMediator, 10);
            Volume_Control_03_Panel_Widget = new Standard_Lab.Main_Page.Volume_Control_03_Panel_Widget(ComponentMediator, 11);
            Admin_Volume_Widget = new Standard_Lab.Main_Page.Admin_Volume_Widget(ComponentMediator, 12);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((Standard_Lab.Main_Page.Proj_01_PowerScreen_Widget)Proj_01_PowerScreen_Widget).AddDevice(device);

            ((Standard_Lab.Main_Page.Proj_02_PowerScreen_Widget)Proj_02_PowerScreen_Widget).AddDevice(device);

            ((Standard_Lab.Main_Page.Admin_Login_Widget)Admin_Login_Widget).AddDevice(device);

            ((Standard_Lab.Main_Page.Proj_02_Source_Widget)Proj_02_Source_Widget).AddDevice(device);

            ((Standard_Lab.Main_Page.Proj_01_Source_Widget)Proj_01_Source_Widget).AddDevice(device);

            ((Standard_Lab.Main_Page.Volume_Control_0x_Panel_Widget)Volume_Control_0x_Panel_Widget).AddDevice(device);

            ((Standard_Lab.Main_Page.Volume_Control_03_Panel_Widget)Volume_Control_03_Panel_Widget).AddDevice(device);

            ((Standard_Lab.Main_Page.Admin_Volume_Widget)Admin_Volume_Widget).AddDevice(device);
        }
        ...
        public void RemoveDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((Standard_Lab.Main_Page.Proj_01_PowerScreen_Widget)Proj_01_PowerScreen_Widget).RemoveDevice(device);

            ((Standard_Lab.Main_Page.Proj_02_PowerScreen_Widget)Proj_02_PowerScreen_Widget).RemoveDevice(device);

            ((Standard_Lab.Main_Page.Admin_Login_Widget)Admin_Login_Widget).RemoveDevice(device);

            ((Standard_Lab.Main_Page.Proj_02_Source_Widget)Proj_02_Source_Widget).RemoveDevice(device);

            ((Standard_Lab.Main_Page.Proj_01_Source_Widget)Proj_01_Source_Widget).RemoveDevice(device);

            ((Standard_Lab.Main_Page.Volume_Control_0x_Panel_Widget)Volume_Control_0x_Panel_Widget).RemoveDevice(device);

            ((Standard_Lab.Main_Page.Volume_Control_03_Panel_Widget)Volume_Control_03_Panel_Widget).RemoveDevice(device);

            ((Standard_Lab.Main_Page.Admin_Volume_Widget)Admin_Volume_Widget).RemoveDevice(device);
        }
        ...
        /// ComplexComponent Proj_01_Power-Screen_Widget
        /// </summary>
        public Standard_Lab.Main_Page.IProj_01_PowerScreen_Widget Proj_01_PowerScreen_Widget { get; private set; }

        /// <summary>
        /// ComplexComponent Proj_02_Power-Screen_Widget
        /// </summary>
        public Standard_Lab.Main_Page.IProj_02_PowerScreen_Widget Proj_02_PowerScreen_Widget { get; private set; }

        /// <summary>
        /// ComplexComponent Admin_Login_Widget
        /// </summary>
        public Standard_Lab.Main_Page.IAdmin_Login_Widget Admin_Login_Widget { get; private set; }

        /// <summary>
        /// ComplexComponent Proj_02_Source_Widget
        /// </summary>
        public Standard_Lab.Main_Page.IProj_02_Source_Widget Proj_02_Source_Widget { get; private set; }

        /// <summary>
        /// ComplexComponent Proj_01_Source_Widget
        /// </summary>
        public Standard_Lab.Main_Page.IProj_01_Source_Widget Proj_01_Source_Widget { get; private set; }

        /// <summary>
        /// ComplexComponent Volume_Control_0x_Panel_Widget
        /// </summary>
        public Standard_Lab.Main_Page.IVolume_Control_0x_Panel_Widget Volume_Control_0x_Panel_Widget { get; private set; }

        /// <summary>
        /// ComplexComponent Volume_Control_03_Panel_Widget
        /// </summary>
        public Standard_Lab.Main_Page.IVolume_Control_03_Panel_Widget Volume_Control_03_Panel_Widget { get; private set; }

        /// <summary>
        /// ComplexComponent Admin_Volume_Widget
        /// </summary>
        public Standard_Lab.Main_Page.IAdmin_Volume_Widget Admin_Volume_Widget { get; private set; }
