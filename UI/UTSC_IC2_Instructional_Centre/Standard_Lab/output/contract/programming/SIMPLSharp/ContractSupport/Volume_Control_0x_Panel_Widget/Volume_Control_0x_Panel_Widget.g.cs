...
namespace Standard_Lab.Volume_Control_0x_Panel_Widget
{
    ...
    public partial interface IVolume_Control_0x_Panel_Widget 
    {
        ...
        /// </summary>
        Standard_Lab.Volume_Control_0x_Panel_Widget.IListMicSelection ListMicSelection { get; }
    }
    ...
    internal partial class Volume_Control_0x_Panel_Widget : IVolume_Control_0x_Panel_Widget, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            ListMicSelection = new Standard_Lab.Volume_Control_0x_Panel_Widget.ListMicSelection(ComponentMediator, 14);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((Standard_Lab.Volume_Control_0x_Panel_Widget.ListMicSelection)ListMicSelection).AddDevice(device);
        }
        ...
        public void RemoveDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((Standard_Lab.Volume_Control_0x_Panel_Widget.ListMicSelection)ListMicSelection).RemoveDevice(device);
        }
        ...
        /// ComplexComponent List.MicSelection
        /// </summary>
        public Standard_Lab.Volume_Control_0x_Panel_Widget.IListMicSelection ListMicSelection { get; private set; }
