...
namespace Mtg_Rm_4176
{
    ...
    /// <summary>
    /// Volume_Control_02_Panel_Widget
    /// </summary>
    public partial interface IVolume_Control_02_Panel_Widget 
    {
        ...
        void BtnSrcVolMuteTgl_Selected(Volume_Control_02_Panel_WidgetBoolInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The bool delegate to update the panel.</param>
        void BtnWirelessMicVolMuteTgl_Selected(Volume_Control_02_Panel_WidgetBoolInputSigDelegate callback);
        ...
        void GuageSrcVol_LowerTouchfb(Volume_Control_02_Panel_WidgetUShortInputSigDelegate callback);
        ...
        /// </summary>
        /// <param name="callback">The ushort delegate to update the panel.</param>
        void GuageWirelessMicVol_LowerTouchfb(Volume_Control_02_Panel_WidgetUShortInputSigDelegate callback);
    ...
    /// <param name="volume_control_02_panel_widget">The <see cref="IVolume_Control_02_Panel_Widget"/> on which to apply the feedback.</param>
    public delegate void Volume_Control_02_Panel_WidgetBoolInputSigDelegate(BoolInputSig boolInputSig, IVolume_Control_02_Panel_Widget volume_control_02_panel_widget);
    /// <summary>
    /// Digital callback used in feedback events.
    /// </summary>
    /// <param name="uShortInputSig">The <see cref="UShortInputSig"/> joinInfo data.</param>
    /// <param name="volume_control_02_panel_widget">The <see cref="IVolume_Control_02_Panel_Widget"/> on which to apply the feedback.</param>
    public delegate void Volume_Control_02_Panel_WidgetUShortInputSigDelegate(UShortInputSig uShortInputSig, IVolume_Control_02_Panel_Widget volume_control_02_panel_widget);

    /// <summary>
    /// Volume_Control_02_Panel_Widget
    /// </summary>
    internal partial class Volume_Control_02_Panel_Widget : IVolume_Control_02_Panel_Widget, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            {
                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_02_Panel_Widget.BtnSrcVolDec.Press
                /// Btn.SrcVolDec.Press
                /// </summary>
                public const uint BtnSrcVolDec_PressEvent = 3;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_02_Panel_Widget.BtnSrcVolInc.Press
                /// Btn.SrcVolInc.Press
                /// </summary>
                public const uint BtnSrcVolInc_PressEvent = 4;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_02_Panel_Widget.BtnSrcVolMuteTgl.Press
                /// Btn.SrcVolMuteTgl.Press
                /// </summary>
                public const uint BtnSrcVolMuteTgl_PressEvent = 5;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_02_Panel_Widget.BtnWirelessMicVolDec.Press
                /// Btn.WirelessMicVolDec.Press
                /// </summary>
                public const uint BtnWirelessMicVolDec_PressEvent = 6;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_02_Panel_Widget.BtnWirelessMicVolInc.Press
                /// Btn.WirelessMicVolInc.Press
                /// </summary>
                public const uint BtnWirelessMicVolInc_PressEvent = 7;

                /// <summary>
                /// Output or Event digital joinInfo from panel to Control System: Volume_Control_02_Panel_Widget.BtnWirelessMicVolMuteTgl.Press
                /// Btn.WirelessMicVolMuteTgl.Press
                /// </summary>
                public const uint BtnWirelessMicVolMuteTgl_PressEvent = 8;


                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Volume_Control_02_Panel_Widget.BtnSrcVolMuteTgl.Selected
                /// Btn.SrcVolMuteTgl.Selected
                /// </summary>
                public const uint BtnSrcVolMuteTgl_SelectedState = 3;

                /// <summary>
                /// Input or Feedback digital joinInfo from Control System to panel: Volume_Control_02_Panel_Widget.BtnWirelessMicVolMuteTgl.Selected
                /// Btn.WirelessMicVolMuteTgl.Selected
                /// </summary>
                public const uint BtnWirelessMicVolMuteTgl_SelectedState = 4;
            ...
            {
                /// <summary>
                /// Output or Event analog joinInfo from panel to Control System: Volume_Control_02_Panel_Widget.GuageSrcVol.LowerTouch
                /// Guage.SrcVol.Lower Touch
                /// </summary>
                public const uint GuageSrcVol_LowerTouchEvent = 4;

                /// <summary>
                /// Output or Event analog joinInfo from panel to Control System: Volume_Control_02_Panel_Widget.GuageWirelessMicVol.LowerTouch
                ...
                /// <summary>
                /// Input or Feedback analog joinInfo from Control System to panel: Volume_Control_02_Panel_Widget.GuageSrcVol.LowerTouchfb
                /// Guage.SrcVol.Lower Touch fb
                /// </summary>
                public const uint GuageSrcVol_LowerTouchfbState = 4;

                /// <summary>
                /// Input or Feedback analog joinInfo from Control System to panel: Volume_Control_02_Panel_Widget.GuageWirelessMicVol.LowerTouchfb
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Volume_Control_02_Panel_Widget"/> component class.
        /// </summary>
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        /// <param name="itemCount">The number of items.</param>
        internal Volume_Control_02_Panel_Widget(ComponentMediator componentMediator, uint controlJoinId, uint? itemCount)
        {
        ...
        /// <param name="componentMediator">The <see cref="ComponentMediator"/> used to instantiate the component.</param>
        /// <param name="controlJoinId">The SmartObjectId at which to create the component.</param>
        internal Volume_Control_02_Panel_Widget(ComponentMediator componentMediator, uint controlJoinId) : this(componentMediator, controlJoinId, null)
        {
        }
        ...
        /// <inheritdoc/>
        public void BtnSrcVolMuteTgl_Selected(Volume_Control_02_Panel_WidgetBoolInputSigDelegate callback)
        {
        ...
        /// <inheritdoc/>
        public void BtnWirelessMicVolMuteTgl_Selected(Volume_Control_02_Panel_WidgetBoolInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void GuageSrcVol_LowerTouchfb(Volume_Control_02_Panel_WidgetUShortInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        /// <inheritdoc/>
        public void GuageWirelessMicVol_LowerTouchfb(Volume_Control_02_Panel_WidgetUShortInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
        ...
        {
            return string.Format("Contract: {0} Component: {1} HashCode: {2} {3}", "Volume_Control_02_Panel_Widget", GetType().Name, GetHashCode(), UserObject != null ? "UserObject: " + UserObject : null);
        }
